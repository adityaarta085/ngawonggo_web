...
let content = fs.readFileSync('src/views/KreativitasPage/components/ImageDetail.js', 'utf8');
...
fs.writeFileSync('src/views/KreativitasPage/components/ImageDetail.js', content);
