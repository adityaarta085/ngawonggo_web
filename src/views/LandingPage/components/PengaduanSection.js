...
const PengaduanSection = () => {
  ...
  const bg = useColorModeValue('linear-gradient(135deg, #FF6A88 0%, #FF99AC 100%)', 'linear-gradient(135deg, #D4145A 0%, #FBB03B 100%)');
        ...
        >
          ...
          >
            ...
            <Button
              ...
              borderRadius="full"
              boxShadow="xl"
              _hover={{ transform: 'translateY(-5px) scale(1.05)', boxShadow: '2xl' }}
              transition="all 0.3s"
