...
let content = fs.readFileSync('src/views/KreativitasPage/components/PublikPage.js', 'utf8');
content = content.replace("<Container maxW=\"container.xl\">", loaderCSS + "\n        <Container maxW=\"container.xl\">");
content = content.replace("objectFit=\"cover\" w=\"full\" h=\"full\" />", `objectFit="cover" w="full" h="full" ${loaderComponent} />`);
fs.writeFileSync('src/views/KreativitasPage/components/PublikPage.js', content);

content = fs.readFileSync('src/views/KreativitasPage/components/HistoriPage.js', 'utf8');
content = content.replace("<Container maxW=\"container.xl\">", loaderCSS + "\n        <Container maxW=\"container.xl\">");
content = content.replace("objectFit=\"cover\" w=\"full\" h=\"full\" />", `objectFit="cover" w="full" h="full" ${loaderComponent} />`);
