...
const oldLogic = `        // 1 & 2. Generate and Upload via Serverless API
...
const newLogic = `        const generationUrl = \`https://api-faa.my.id/faa/ai-text2img-pro?prompt=\${encodeURIComponent(prompt)}\`;
